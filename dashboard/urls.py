...
urlpatterns = [
    ...
    path('admin-quizzes/<int:quiz_id>/toggle-live/', views.admin_quiz_toggle_live, name='admin_quiz_toggle_live'),
    path('admin-quizzes/publish-all/', views.admin_quiz_publish_all, name='admin_quiz_publish_all'),
    path('admin-quizzes/unpublish-all/', views.admin_quiz_unpublish_all, name='admin_quiz_unpublish_all'),
